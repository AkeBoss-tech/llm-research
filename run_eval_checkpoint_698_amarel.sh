#!/bin/bash
#SBATCH --job-name=eval_checkpoint_698
#SBATCH --output=eval_checkpoint_698_%j.out
#SBATCH --error=eval_checkpoint_698_%j.err
...
# ==========================================
# Amarel Cluster Script: Evaluate Checkpoint 698
# ==========================================
# This script evaluates the checkpoint at step 698 on GSM8K.
...
if [ -d "/scratch/$USER" ] && [ -w "/scratch/$USER" ]; then
    OUTPUT_DIR="/scratch/$USER/gsm8k_eval_checkpoint_698/job_${SLURM_JOB_ID}"
    echo "Using /scratch for output"
else
    OUTPUT_DIR="$HOME/gsm8k_eval_checkpoint_698/job_${SLURM_JOB_ID}"
